...
export function DrawingToolRail({
  ...
  return (
    <div
      ref={ref}
      className="absolute left-1 top-8 z-20"
    >
      <div
        className={cn(
          "flex flex-col items-center gap-0.5 rounded-md bg-card/90 border border-border p-0.5 backdrop-blur-sm",
      ...
      <button
        ...
        className="absolute -right-3 top-1/2 z-30 -translate-y-1/2 rounded-full border border-border bg-card p-1 text-muted-foreground shadow-md hover:text-foreground"
      >
        {hidden ? (
