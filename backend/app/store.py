...
class MarketDataStore:
    ...
    def set_health(self, exchange: str, *, connected: bool, last_event_at: int | None) -> None:
    ...
    def get_health(self, exchange: str) -> ExchangeHealth:
        return self._health.get(exchange, ExchangeHealth(connected=False, lastEventAt=None))
